      ...
      <Container className="container-principal-treinamentos">
        ...
        <div className="colunas">
          ...
          <div className="textos">
            <div>
              Olá, sou Jociel Moreira, um apaixonado pelo desenvolvimento humano
              e uma alma inquieta em busca do conhecimento sobre a mente humana.
              Sou formado em Engenharia Civil, mas minha verdadeira paixão
              sempre foi a transformação de vidas através do treinamento e
              inspiração.
            </div>
            <div>
              <h4>Minha Missão:</h4>
              <span>
                ...
                alcançar grandes feitos e realizar seus sonhos mais audaciosos.
                Minha missão de vida é treinar e inspirar pessoas a descobrirem
                a melhor versão de si mesmas, capacitando-as a superar desafios
                e conquistar suas metas e objetivos.
              </span>
            </div>
            <div></div>
            <div>
              ...
              <span>
                Em minhas palestras e treinamentos, compartilho com entusiasmo e
                empatia o conhecimento que tenho adquirido em minha intensa
            ...
            <div>
              ...
              <span>
                Meu objetivo é guiar meus ouvintes e alunos a desbloquearem seu
                verdadeiro potencial, eliminando crenças limitantes e
                desenvolvendo habilidades para enfrentar os desafios da vida com
                confiança e determinação.
              </span>

              <span>
                Se você deseja conquistar seus objetivos mais ousados, atingir
                níveis mais elevados de sucesso pessoal e profissional e, acima
                de tudo, impactar positivamente sua vida e a vida dos outros, eu
